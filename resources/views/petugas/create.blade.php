...
<span class="inline-flex items-center gap-2">
  <a href="{{ route('petugas.dashboard') }}" class="text-slate-400 hover:text-slate-600 transition-colors mr-1">
    <i class="fas fa-arrow-left text-base"></i>
  </a>
  <span>Tambah Pendaftaran Baru</span>
</span>
@endsection
@section('subtitle', 'Entri data pendaftar baru oleh petugas pendaftaran')
...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
  ...
  <div class="xl:col-span-2">
    ...
    {{-- Form --}}
    <form method="POST" action="{{ route('petugas.store') }}" enctype="multipart/form-data" class="p-6 sm:p-8 space-y-8">
      @csrf
      ...
      <div class="flex items-center gap-3 pt-4 border-t border-slate-100">
        ...
        <a href="{{ route('petugas.dashboard') }}" class="bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold px-6 py-3 rounded-xl transition-all">
          Batal
        </a>
      </div>
  ...
  <div class="xl:col-span-1">
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden sticky top-6">
      <div class="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
        ...
        <a href="{{ route('petugas.dashboard') }}" class="text-xs text-primary hover:underline">Lihat Semua</a>
      </div>
        ...
        <div class="px-5 py-3 flex items-start gap-3 hover:bg-slate-50 transition-colors group">
          ...
          <div class="flex-1 min-w-0">
            ...
            <div class="flex items-center gap-2 mt-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
              <a href="{{ route('petugas.show', $item) }}" class="text-xs text-blue-600 hover:text-blue-800 font-medium">
