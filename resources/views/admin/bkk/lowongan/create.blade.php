...
@endsection
@section('subtitle', 'Tambahkan informasi lowongan pekerjaan baru dari mitra industri')

@section('content')
<div class="max-w-4xl">
  <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
    <form method="POST" action="{{ route('admin.bkk.lowongan.store') }}" enctype="multipart/form-data" class="p-6 space-y-8">
      @csrf
      ...
      <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p class="text-xxs text-slate-400 mt-1">Format: JPG, PNG, GIF. Maks: 2MB.</p>
      ...
      <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input type="text" id="jurusan_relevan" name="jurusan_relevan" value="{{ old('jurusan_relevan') }}"
              class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-primary/30 focus:border-primary outline-none transition text-sm"
          ...
          <div>
            ...
            <input type="date" id="batas_lamaran" name="batas_lamaran" value="{{ old('batas_lamaran') }}" required
              class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-primary/30 focus:border-primary outline-none transition text-sm">
        ...
        <div class="space-y-6">
          <div>
            ...
            <textarea id="deskripsi" name="deskripsi" rows="5"
              ...
              placeholder="Jelaskan mengenai tugas pekerjaan, tunjangan, jam kerja, atau hal penting lainnya...">{{ old('deskripsi') }}</textarea>
          ...
          <div>
            ...
            <input type="file" id="brosur" name="brosur" accept="image/*"
              class="block w-full text-sm text-slate-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-semibold file:bg-orange-50 file:text-primary hover:file:bg-orange-100 transition">
            <p class="text-xxs text-slate-400 mt-1">Format: JPG, PNG, GIF. Maks: 4MB.</p>
          ...
          <div>
            ...
            <div id="persyaratan-container" class="space-y-2">
              @php $oldPersyaratan = old('persyaratan', ['']); @endphp
      ...
      <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input type="text" id="kontak_lamaran" name="kontak_lamaran" value="{{ old('kontak_lamaran') }}"
              class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-primary/30 focus:border-primary outline-none transition text-sm"
