...
@section('content')
  ...
  <section class="relative h-[40vh] overflow-hidden">
    ...
    @else
      <img src="https://picsum.photos/seed/tav-hero/1920/600" alt="Jurusan {{ $content->nama_jurusan }}" class="w-full h-full object-cover">
    @endif
  ...
  <section class="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 sticky top-16 z-40">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex overflow-x-auto gap-1 py-2 scrollbar-hide">
        ...
        <a href="/jurusan/tav"  class="jurusan-tab active whitespace-nowrap px-4 py-2 rounded-lg text-sm font-medium transition"><i class="fas fa-tv mr-1"></i> TAV</a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div class="grid grid-cols-2 gap-4">
          <img src="https://picsum.photos/seed/tav1/300/200" alt="Praktikum TAV 1" class="gallery-img w-full h-40 object-cover shadow-md activity-preview-img cursor-pointer">
          <img src="https://picsum.photos/seed/tav2/300/200" alt="Praktikum TAV 2" class="gallery-img w-full h-40 object-cover shadow-md activity-preview-img cursor-pointer">
          <img src="https://picsum.photos/seed/tav3/300/200" alt="Praktikum TAV 3" class="gallery-img w-full h-40 object-cover shadow-md activity-preview-img cursor-pointer">
          <img src="https://picsum.photos/seed/tav4/300/200" alt="Praktikum TAV 4" class="gallery-img w-full h-40 object-cover shadow-md activity-preview-img cursor-pointer">
        </div>
      </div>
    </div>
  </section>
