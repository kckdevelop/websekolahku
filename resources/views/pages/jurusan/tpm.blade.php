    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div class="grid grid-cols-2 gap-4">
          <img src="https://picsum.photos/seed/tpm1/300/200" alt="Praktikum TPM 1" class="gallery-img w-full h-40 object-cover shadow-md">
          <img src="https://picsum.photos/seed/tpm2/300/200" alt="Praktikum TPM 2" class="gallery-img w-full h-40 object-cover shadow-md">
          <img src="https://picsum.photos/seed/tpm3/300/200" alt="Praktikum TPM 3" class="gallery-img w-full h-40 object-cover shadow-md">
          <img src="https://picsum.photos/seed/tpm4/300/200" alt="Praktikum TPM 4" class="gallery-img w-full h-40 object-cover shadow-md">
        </div>
      </div>
    </div>
  </section>
