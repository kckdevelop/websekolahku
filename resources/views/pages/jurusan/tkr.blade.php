  ...
  <section class="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 sticky top-16 z-40">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex overflow-x-auto gap-1 py-2 scrollbar-hide">
        <a href="/jurusan/tkr"  class="jurusan-tab active whitespace-nowrap px-4 py-2 rounded-lg text-sm font-medium transition"><i class="fas fa-car mr-1"></i> TKR</a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div class="grid grid-cols-2 gap-4">
          <img src="https://picsum.photos/seed/tkr1/300/200" alt="Praktikum 1" class="gallery-img w-full h-40 object-cover shadow-md">
          <img src="https://picsum.photos/seed/tkr2/300/200" alt="Praktikum 2" class="gallery-img w-full h-40 object-cover shadow-md">
          <img src="https://picsum.photos/seed/tkr3/300/200" alt="Praktikum 3" class="gallery-img w-full h-40 object-cover shadow-md">
          <img src="https://picsum.photos/seed/tkr4/300/200" alt="Praktikum 4" class="gallery-img w-full h-40 object-cover shadow-md">
        </div>
      </div>
    </div>
  </section>
