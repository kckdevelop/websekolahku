...
@section('style')
    ...
    .dark .card-gradient { background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); border-color: #334155; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.5); }
...
@section('content')
  ...
  <section class="relative h-[40vh] overflow-hidden">
    ...
    @else
      <img src="https://picsum.photos/seed/tpm-hero/1920/600" alt="Jurusan {{ $content->nama_jurusan }}" class="w-full h-full object-cover">
    @endif
  ...
  <section class="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 sticky top-16 z-40">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex overflow-x-auto gap-1 py-2 scrollbar-hide">
        ...
        <a href="/jurusan/tpm"  class="jurusan-tab active whitespace-nowrap px-4 py-2 rounded-lg text-sm font-medium transition"><i class="fas fa-cogs mr-1"></i> TPM</a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div class="grid grid-cols-2 gap-4">
          <img src="https://picsum.photos/seed/tpm1/300/200" alt="Praktikum TPM 1" class="gallery-img w-full h-40 object-cover shadow-md activity-preview-img cursor-pointer">
          <img src="https://picsum.photos/seed/tpm2/300/200" alt="Praktikum TPM 2" class="gallery-img w-full h-40 object-cover shadow-md activity-preview-img cursor-pointer">
          <img src="https://picsum.photos/seed/tpm3/300/200" alt="Praktikum TPM 3" class="gallery-img w-full h-40 object-cover shadow-md activity-preview-img cursor-pointer">
          <img src="https://picsum.photos/seed/tpm4/300/200" alt="Praktikum TPM 4" class="gallery-img w-full h-40 object-cover shadow-md activity-preview-img cursor-pointer">
        </div>
      </div>
    </div>
  </section>
